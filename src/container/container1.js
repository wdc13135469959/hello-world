...
import Head from '../teacher/head1';
import LeftSelect from'../teacher/left_select1'
import Content from'../teacher/content'
import ContentApp from '../teacher/content-app'
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            data: {
                ...
                "status": 200,
                "rewards": [{"id": 2, "name": "演讲比赛", "type": "1", "des": "", "score": 200},
                    {"id": 3, "name": "清洁卫生", "type": "1", "des": "", "score": 100}, {
                        "id": 4,
                        "name": "三好学生",
                        "type": "1",
                        "des": "",
                        "score": 300
                    }, {"id": 5, "name": "学院活动比赛", "type": "1", "des": "", "score": 300}, {
                        "id": 6,
                        "name": "班级争光",
                        "type": "1",
                        "des": "",
                        "score": 100
                    }, {"id": 7, "name": "班委", "type": "1", "des": "", "score": 300}, {
                        "id": 8,
                        "name": "上课迟到",
                        "type": "2",
                        "des": "",
            ...
            //控制弹出框
            showMask: false,
            colors: ["#00C78C", "#FF00FF", "#FF6100", "#FFDEAD", "#9C661F", "#FFD700"]
        }
    }
    ...
    render() {
        ...
        return (
            <div style={{height:"100%"}}>
                ...
                <LeftSelect/>
                <Content/>
                <ContentApp students={this.state.data.students}/>
            </div>
        );
